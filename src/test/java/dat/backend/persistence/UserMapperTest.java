...
class UserMapperTest
{
    ...
    {
        User newUser = UserFacade.createUser("Vivek", "1234", "customer", connectionPool);
        User logInUser = UserFacade.login("Vivek", "1234", connectionPool);
        User expectedUser = new User("Vivek", "1234", "customer");
