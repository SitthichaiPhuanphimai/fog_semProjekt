...
class UserMapperTest
{
    ...
    {
        User expectedUser = new User("ben", "25547999", "1234", "user");
    ...
    {
        User newUser = UserFacade.createUser("jill", "40425799","1234", "user", connectionPool);
        User logInUser = UserFacade.login("jill", "1234", connectionPool);
        User expectedUser = new User("jill", "40425799","1234", "user");
